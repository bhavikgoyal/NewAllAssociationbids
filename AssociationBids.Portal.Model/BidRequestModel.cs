...
{
    public class BidRequestModel : BaseModel
    {
        ...
        public string VendorSSdates { get; set; }
        ...
        public decimal MinimumInsAmount { get; set; }
        public string BidAmounts { get; set; }
        public string BidAmountT { get; set; }
    ...
    public bool isExpired { get; set; }
        ...
        public string InsuranceAmountT { get; set; }

...
Go
insert into lookup (LookUpKey,LookUpTypeKey,Title,Value,SortOrder) values (1616,15,'Bid Report',1,1)
insert into lookup (LookUpKey,LookUpTypeKey,Title,Value,SortOrder) values (1617,15,'Bid Date Extension',0,0)
insert into lookup (LookUpKey,LookUpTypeKey,Title,Value,SortOrder) values (1618,15,'Bid Date Extended',0,0)
...
insert into EmailTemplate (EmailTitle,EmailSubject,Body,DateAdded,lookUpType) values 
('Bid Report','Bid Report','<p>Hello [MemberName],</p>    <p>Find your Attachment</p>    <p>Assocation Bids.</p>    <p>Thanks Association Bids Team</p>',GETDATE(),1616)
insert into EmailTemplate (EmailTitle,EmailSubject,Body,DateAdded,lookUpType) values 
('Bid ReportBid Date Extension','Bid Due Date Extension Request by [VendorName]','<p>hii [MemberName]</p>    <p>You have requested by [VendorName] to exten the Bid Due Date of [BidName] Bid</p>    <p>Thanks</p>    <p>Association Bids Team</p>    <p>&nbsp;</p>',GETDATE(),1617)
insert into EmailTemplate (EmailTitle,EmailSubject,Body,DateAdded,lookUpType) values 
('Bid Date Extened','Bid Due Date are Extened [BidName]','<p>hii [MemberName],</p>    <p>You have requested by [VendorName] to exten the Bid Due Date of [BidName] Bid</p>    <p>Thanks</p>    <p>Association Bids Team</p>    <p>&nbsp;</p>  ',GETDATE(),1618)

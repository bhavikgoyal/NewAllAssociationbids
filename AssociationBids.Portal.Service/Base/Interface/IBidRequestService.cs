...
{
    public interface IBidRequestService : IBaseService
    {
        bool Validate(BidRequestModel item);
        bool IsFilterEnabled(BidRequestFilterModel filter);
        BidRequestFilterModel CreateFilter();
        BidRequestFilterModel CreateFilter(BidRequestModel item);
        BidRequestFilterModel UpdateFilter(BidRequestFilterModel filter);
        BidRequestModel Create();
        ...
        //IList<BidRequestModel> GetbindDocument(int PropertyKey);
        ...
        string SearchBidRequestVenderjson(Int64 PageSize, Int64 PageIndex, string Search, String Sort, Int64 BidRequestKey,Int64 CompanyKey,Int64 UserId, string BidRequestStatus, string BiddueDateFrom, string BiddueDateTo,string ModuleController,long ResourceKey = 0);
        string SearchBidRequestVenderjsonPriority(Int64 PageSize, Int64 PageIndex, string Search, String Sort, Int64 BidRequestKey,Int64 CompanyKey,Int64 UserId, string BidRequestStatus, string BiddueDateFrom, string BiddueDateTo,string ModuleController,long ResourceKey);

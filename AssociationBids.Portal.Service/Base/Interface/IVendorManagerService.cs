...
{
    public interface IVendorManagerService : IBaseService
    {
        ...
        Int64 VendorManagerUpdate(VendorManagerVendorModel item);
        ...
        bool EditService(int CompanyKey,string servicekey);
